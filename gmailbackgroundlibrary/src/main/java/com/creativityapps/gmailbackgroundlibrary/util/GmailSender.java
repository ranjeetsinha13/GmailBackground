...
public class GmailSender extends javax.mail.Authenticator {
    ...
    public synchronized void sendMail(String subject, String body, String sender, String senderName, String recipients, String type) throws Exception {
        ...
        message.setFrom(TextUtils.isEmpty(senderName) ?
                ...
                new InternetAddress(sender, senderName));
